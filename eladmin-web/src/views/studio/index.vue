  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <el-input v-model="query.partnerTag" clearable placeholder="合作商标签" style="width: 185px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="合作商中文名" prop="partnerNamec">
            <el-input v-model="form.partnerNamec" style="width: 370px;" />
          </el-form-item>
          ...
          <el-form-item label="合作商手机号">
            <el-input v-model="form.partnerPhone" style="width: 370px;" />
          </el-form-item>
          <el-form-item label="合作商邮箱">
            <el-input v-model="form.partnerMail" style="width: 370px;" />
          </el-form-item>
        </el-form>
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column prop="partnerTag" label="合作商标签">
          <template slot-scope="scope">
            {{ dict.label.studio_partner_tag[scope.row.partnerTag] }}
          </template>
        </el-table-column>
